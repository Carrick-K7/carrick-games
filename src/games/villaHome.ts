...
export const VILLA_HOME_LIGHTS: readonly VillaHomeLight[] = [
  ...
  { id: 'gaming', name: 'Gaming room', zh: '电竞房', floor: 0, fixtures: [{ x: 7.2, y: 3.1, z: 6.1 }] },
  { id: 'snooker', name: 'Snooker lounge', zh: '斯诺克厅', floor: 0, fixtures: [{ x: 9.2, y: 3.12, z: -3.8 }] },
  ...
  { id: 'bath', name: 'Bathroom', zh: '浴室', floor: 1, fixtures: [{ x: 9.1, y: 6.72, z: -4.2 }] },
  { id: 'library', name: 'Reading lounge', zh: '书房', floor: 1, fixtures: [{ x: 7.1, y: 6.72, z: 6 }] },
...
export const VILLA_SECURITY_CAMERAS: readonly VillaSecurityCamera[] = [
  ...
  { id: 'roof', name: 'Roof garden', zh: '天台', position: { x: 10.8, y: 9.3, z: 8.5 }, target: { x: -5, y: 7.7, z: 3.6 } },
