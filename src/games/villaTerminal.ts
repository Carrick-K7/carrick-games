...
div[data-villa-terminal] button{min-height:44px;padding:9px 14px;border:1px solid var(--vt-line);border-radius:10px;background:var(--vt-card);color:inherit;font:inherit;cursor:pointer;touch-action:manipulation}
