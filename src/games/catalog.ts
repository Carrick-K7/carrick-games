...
export const GAMES: GameMeta[] = [
  ...
  },
  {
    ...
    name: 'Iceberg Strike',
    nameZh: '冰封突袭',
    desc: 'CS-style bomb-defusal FPS on the frozen Iceberg map. Buy gear, read the A/B execute, and defuse the bomb before it detonates.',
    descZh: '类 CS 的爆破 FPS,战场是冰封的 Iceberg 地图。购买装备,判断 A/B 进攻,并在炸弹引爆前拆弹。',
    ...
    controls: {
      keyboard: [
        ...
        { keys: ['E'], action: 'Defuse bomb', actionZh: '拆除炸弹' },
        { keys: ['1', '2', '3'], action: 'Pistol / SMG / Rifle', actionZh: '手枪 / 冲锋枪 / 步枪' },
        { keys: ['4', '5', '6'], action: 'Armor / Kit / Helmet', actionZh: '护甲 / 拆弹器 / 头盔' },
      ...
      touch: [
        ...
        { icon: 'tap', action: 'Tap buy rows / fire / reload / defuse buttons', actionZh: '点击购买项 / 开火 / 换弹 / 拆弹按钮' },
      ],
    },
  },
];
