...
export const GAMES: GameMeta[] = [
  ...
  },
  {
    ...
    name: 'Warm Villa',
    nameZh: '暖居别墅',
    desc: 'Villa 1.1.0: a cozy 3D home with tea, pets, smart controls and a drivable country estate.',
    descZh: '别墅 1.1.0：品茶、陪伴小动物、操控智能家居，驾车探索温馨的三层住宅与乡间庄园。',
    loader: () => import('./villa.js').then((m) => m.VillaGame),
    canvasSize: { width: 1120, height: 700 },
    controls: {
      keyboard: [
        { keys: ['W', 'A', 'S', 'D'], action: 'Walk / drive; A/D steers', actionZh: '行走 / 驾驶；A/D 转向' },
        { keys: ['W', 'S'], action: 'Road vehicles: accelerate / brake, then reverse', actionZh: '车辆：前进 / 先刹停再倒车' },
        ...
        { keys: ['E'], action: 'Context action / feed / sit / lie / leave', actionZh: '互动 / 投喂 / 入座 / 躺下 / 离开' },
        { keys: ['Q'], action: 'Carry/place camping chair; door / screen input', actionZh: '搬放露营椅；车门 / 大屏信号' },
        { keys: ['P'], action: 'Smart-home terminal', actionZh: '智能家居终端' },
        { keys: ['?'], action: 'Toggle controls guide', actionZh: '展开 / 收起统一操作指南' },
        ...
        { keys: ['T'], action: 'Cycle day / evening / night', actionZh: '切换白天 / 傍晚 / 夜晚' },
        { keys: ['R', 'H'], action: 'Activity reset / home', actionZh: '玩法复位 / 回门口' },
      ],
      touch: [
        { icon: 'swipe', action: 'Left stick: walk/drive; right drag: look/aim', actionZh: '左杆行走/驾驶,右侧环顾/瞄准' },
        { icon: 'tap', action: 'Context actions and smart terminal; tap location to leave immersive mode', actionZh: '点按钮互动或打开智能终端；沉浸时点位置信息退出' },
      ],
      notes: [
        { text: 'Play starts automatically. Click the scene for mouse capture; Esc releases it. Browser fullscreen remains F11, with no in-game fullscreen action.', textZh: '进入后自动开始。点击画面捕获鼠标，Esc 释放；全屏由浏览器 F11 管理，游戏不提供全屏操作。' },
        { text: 'Sedan, pickup and scooter: W accelerates; S brakes first, then reverses when stopped. A/D steers, Space is the handbrake and R safely resets. The rally rig uses S as a service brake only.', textZh: '轿车、皮卡和电动车：W 前进，S 先刹停再倒车；A/D 转向，空格手刹，R 安全复位。拉力模拟器的 S 仅用于刹车。' },
        { text: 'E follows the visible prompt: interact, sit/lie down, use the swing or leave. Near the camping chair, Q picks it up or places it on clear ground; elsewhere Q retains door/screen actions.', textZh: 'E 按当前提示互动、坐下/躺下、坐秋千或离开。露营椅旁 Q 搬起或放在空地；其他场景保留车门/屏幕辅助操作。' },
  ...
  {
    id: 'cs',
    group: 'action', order: 7.4, icon: 'counterstrike', // heads the Action family
    name: 'CS',
    nameZh: '反恐精英',
    desc: 'Browser tactical FPS on real CS maps — fy_snow elimination, Dust II bomb defusal and team deathmatch, 5v5 against bots.',
    descZh: '浏览器战术射击:雪地竞技场歼灭、炙热沙城Ⅱ双包点爆破与团队竞技,5v5 机器人对战。',
    loader: () => import('./cs.js').then((m) => m.CsGame),
    canvasSize: { width: 1280, height: 720 },
    controls: {
      keyboard: [
        { keys: ['W', 'A', 'S', 'D'], action: 'Move', actionZh: '移动' },
        { keys: ['Mouse'], action: 'Look / Fire (pointer lock)', actionZh: '瞄准 / 射击(指针锁定)' },
        { keys: ['Right click'], action: 'Scope / secondary', actionZh: '开镜 / 辅助攻击' },
        { keys: ['R'], action: 'Reload', actionZh: '换弹' },
        { keys: ['E'], action: 'Pick up / plant / defuse', actionZh: '拾取 / 安放 / 拆除' },
        { keys: ['B'], action: 'Buy menu (Dust II)', actionZh: '购买菜单(沙城)' },
        { keys: ['Tab'], action: 'Scoreboard', actionZh: '记分板' },
        { keys: ['M'], action: 'Tactical map', actionZh: '战术地图' },
        { keys: ['1', '2', '3', '4', '5'], action: 'Primary / Pistol / Knife / Grenade / C4', actionZh: '主武器 / 手枪 / 刀 / 手雷 / C4' },
        { keys: ['G', 'Q', 'F'], action: 'Drop / last weapon / inspect', actionZh: '丢枪 / 上一武器 / 检视' },
        { keys: ['Z', 'X', 'C'], action: 'Radio menus', actionZh: '无线电菜单' },
        { keys: ['Shift', 'Ctrl', 'Space'], action: 'Walk / Crouch / Jump', actionZh: '静步 / 蹲下 / 跳跃' },
        { keys: ['Esc'], action: 'Pause', actionZh: '暂停' },
      ],
      keyboardPanel: [
      ...
      touch: [
        ...
        { icon: 'tap', action: 'Fire / reload / jump / use buttons', actionZh: '开火 / 换弹 / 跳 / 拾取按钮' },
      ],
    },
  },
  {
    id: 'cs-kimi',
    group: 'action', order: 7.5, icon: 'counterstrike',
    name: 'CS Kimi',
    nameZh: '反恐精英 Kimi 版',
