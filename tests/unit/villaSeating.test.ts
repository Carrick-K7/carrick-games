...
import { VILLA_AQUARIUM, VILLA_BEDS, VILLA_RELAX_SEATS, resolveVillaSeatPosition, villaBedRestPose, villaRelaxSeat, villaSeatColliderId, villaSeatExitCandidates } from '../../src/games/villaSeating';
import { VILLA_FIREPLACE_WALL } from '../../src/games/villaLivingLayout';
