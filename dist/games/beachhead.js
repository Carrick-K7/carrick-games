...
export class BeachHeadGame extends BaseGame {
    ...
    draw(ctx) {
        ...
        ctx.lineTo(TURRET_X + Math.cos(this.aimAngle) * 58, TURRET_Y + Math.sin(this.aimAngle) * 58);
        ctx.stroke();
        ctx.fillStyle = text;
    ...
    drawTurret(ctx, bunker, accent, isDark) {
...
//# sourceMappingURL=beachhead.js.map