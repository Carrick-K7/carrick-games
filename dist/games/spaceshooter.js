...
export class SpaceShooterGame extends BaseGame {
    constructor() {
        ...
        this.enemyWidth = 30;
        this.enemyHeight = 30;
        this.enemyMinSpeed = 60;
        this.enemyMaxSpeed = 120;
        this.spawnTimer = 0;
    ...
    update(dt) {
        ...
        for (const enemy of this.enemies) {
            ...
            if (this.checkCollision({ x: this.playerX, y: this.playerY, width: this.playerWidth, height: this.playerHeight }, enemy)) {
                this.gameOver = true;
                return;
            }
...
//# sourceMappingURL=spaceshooter.js.map