...
**Last reconciled with production:** 2026-09-20, scoped to CS `1.1.0` at `7b2e355e3854f1f33034ca459501bfb3ec299182` and its pinned published shell `0.4.0` at `831408bdee7070d459bf0190e4db8154ded6da0c`. Exact-SHA Actions run `35509293470` passed; public identity, content types and SHA-256 inventories passed for all 169 CS files, 10 shell files and 57 retained CS `1.0.1` files at `809eafa18ec4d0d16b35e99046c15a9e267793bd`. Missing game/shell resources returned 404, and live Chromium gameplay loaded nine animated bots without page or HTTP errors. Villa remains `1.10.0` at `da8256e0464256636f739575538fb64527b69100`; all non-CS catalog entries and the shell were unchanged, not republished or independently gameplay-reverified in this check. This line is a claim like any other: re-check live `/games/index.json` and `/manifest.json` before trusting it, and update it whenever a statement here is verified or corrected.
