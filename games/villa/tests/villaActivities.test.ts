...
describe('Villa activity defaults and screen inputs', () => {
  it('returns independently mutable state with the expected defaults', () => {
    ...
    expect(first).toEqual({ carDoorOpen: false, pickupDoorOpen: false, suvDoorOpen: false, seated: null, relaxSeatId: null, relaxSeatPosition: null, relaxEntryPosition: null, screenSource: 'pc', displayLights: true });
    ...
    expect(second).toEqual({ carDoorOpen: false, pickupDoorOpen: false, suvDoorOpen: false, seated: null, relaxSeatId: null, relaxSeatPosition: null, relaxEntryPosition: null, screenSource: 'pc', displayLights: true });
