...
import { BaseGame, type GameHost, type GameViewport } from '@carrick/game-sdk/game';
import { canvasBackingScale, MAX_CANVAS_BACKING_PIXELS } from '@carrick/game-sdk/render';
